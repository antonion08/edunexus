...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-start p-6 md:p-10 w-full bg-black/80">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
        <div className="bg-black/30 backdrop-blur-md rounded-2xl p-6 flex flex-col items-center shadow-lg border border-white/10 hover:scale-[1.03] transition-transform">
      ...
      <div className="w-full max-w-6xl mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-black/30 backdrop-blur-md rounded-xl p-5 shadow-md border border-white/10 flex flex-col items-center hover:scale-[1.02] transition-transform">
